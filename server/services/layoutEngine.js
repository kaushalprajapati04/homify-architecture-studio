...
function calculateSetbacks(plotW, plotD) {
...
function generateFloorPlan(project = {}) {
...
function modifyFloorPlan(currentPlan, instruction = '') {
...
module.exports = {
  ...
  categorizeRooms,
  modifyFloorPlan,
  validateFloor: (floor) => ({ valid: true, errors: [], warnings: [] }),
};
