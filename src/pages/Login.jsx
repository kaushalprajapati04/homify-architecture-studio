    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-1 blueprint-grid relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <svg viewBox="0 0 400 400" className="w-full max-w-md opacity-90">
            ...
            {[
              { x: 50, y: 50, w: 140, h: 120, l: 'LIVING' },
              { x: 190, y: 50, w: 160, h: 120, l: 'KITCHEN' },
              { x: 50, y: 170, w: 120, h: 180, l: 'BEDROOM' },
              { x: 170, y: 170, w: 180, h: 90, l: 'BATH' },
              { x: 170, y: 260, w: 180, h: 90, l: 'DINING' },
            ].map((r, i) => (
              <motion.g key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 + i * 0.2 }}>
                ...
                <text x={r.x + r.w / 2} y={r.y + r.h / 2} fill="rgba(74,144,217,0.6)" fontSize="11" fontFamily="monospace" textAnchor="middle" dominantBaseline="middle">{r.l}</text>
              </motion.g>
            ))}
            <motion.circle cx="370" cy="40" r="10" fill="none" stroke="rgba(74,144,217,0.5)" strokeWidth="1"
              initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }} />
            <line x1="370" y1="40" x2="370" y2="30" stroke="rgba(74,144,217,0.7)" strokeWidth="1.5" />
            <text x="370" y="24" fill="rgba(74,144,217,0.6)" fontSize="9" fontFamily="monospace" textAnchor="middle">N</text>
          </svg>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-ink-50">
        ...
        >
          ...
          <p className="text-ink-500 mb-8">Sign in to continue designing.</p>
          ...
          <p className="text-center text-sm text-ink-500 mt-6">
            ...
            <Link to="/register" className="text-accent-600 font-semibold hover:text-accent-700">Sign up</Link>
          </p>
        </motion.div>
      </div>
    </div>
